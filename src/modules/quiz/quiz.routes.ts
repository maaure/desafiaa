...
export async function quizRoutes(app: FastifyInstance) {
  ...
  app.post<{ Params: { id: string } }>("/api/quizzes/:id/questions", async (request, reply) => {
    ...
    const question = await quizService.createQuestion(request.params.id, (request as any).userId, input);
  ...
  app.post<{ Params: { id: string } }>("/api/questions/:id/alternatives", async (request, reply) => {
    ...
    const alt = await quizService.createAlternative(request.params.id, (request as any).userId, input);
